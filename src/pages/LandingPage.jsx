  ...
  return (
    ...
    <>
      ...
      <div className='w-full min-h-full bg-[#F7CFD8]'>
        ...
        <div className='max-w-7xl mx-auto px-4 pt-6 pb-[200px] relative z-10'>
          { /* Headers */ }
          ...
          {/* Hero Content */}
       <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0 text-center md:text-left'>
            ...
            <div className='w-full md:w-1/2'>
              ...
              <button className='bg-black text-sm font-semibold text-white px-7 py-2.5 w-full sm:w-auto rounded-full hover:bg-[#FFEEF4] hover:text-black border border-[#F7CFD8] hover:border-[#670D2F] transition-colors cursor-pointer' onClick={handleCTA}>
                Get Started
              </button>
      ...
      <div className='w-full bg-[#F7CFD8] min-h-full relative z-10'>
        <div>
       <section className='flex items-center justify-center px-4 -mt-36'>
            <img src={HERO} alt="Hero Image" className='w-full max-w-5xl rounded-lg' />
          </section>
        </div>
